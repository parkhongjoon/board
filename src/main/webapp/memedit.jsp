    ...
    <section>
       ...
       <div class="listbox">
          ...
          <p class="text-danger">* 표시가 되어 있는 부분은 필수 항목입니다.</p>
                     ...
                     <form name="registerForm" action="memeditok.jsp" id="registerform2" class="registerform" method="post">
                    <div class="row">
                        <div class="col-5 d-flex align-items-center mb-4">
                            <label for="username" class="text-right mr-3 col-4">이름*</label>
                            <input type="text" name="username" id="username" 
                                   class="form-control col-8" value="<%=sess3.getAttribute("username")%>" placeholder="이름"/>
                        </div>
                        <div class="col-5 d-flex align-items-center mb-4">
                            <label for="uid" class="text-right mr-3 col-4">아이디*</label>
                            <input type="text" name="userid" id="userid" 
                                   class="form-control col-8" placeholder="아이디" value="<%=sess3.getAttribute("userid") %>" readonly  />
                        </div>
                        ...
                        <div class="col-5 d-flex align-items-center mb-4">
                            ...
                            <input type="text" name="userpass" id="userpass"
                                   class="form-control col-8" value="<%=userpass %>" placeholder="비밀번호">
                        </div>
                        <div class="col-5 d-flex align-items-center mb-4">
